  ...
  return (
    <section id="home" className="container h-[95vh]">
      <article className=" text-center ">
        ...
        <h1 className=" uppercase tracking-wider font-black bg-gradient-to-r from-indigo-600 via-purple-700 to-sky-500 bg-clip-text text-transparent text-[100px] mb-4 max-sm:text-6xl animate-title">jun choi</h1>
