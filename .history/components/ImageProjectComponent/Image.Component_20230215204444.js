        ...
        <div className='project-group'>
          ...
          <div className='project-detail'>
            <a
              ...
              onClick={() => alert('Warning!!!, web ini mengadung Deceptive site ahead karena web ini memiliki feature payment, untuk memasukinya tekan details dan visit this unsafe site')}
              target='_blank'
              rel='noreferrer'
              href={directUrl}
