      ...
      <article className='project'>
        <div className='project-group'>
          ...
          <div className='project-detail'>
            <a
              onClick={danger ? () => alert('Warning!!!, web ini mengadung Deceptive site ahead karena web ini memiliki feature payment, untuk memasukinya tekan details dan visit this') : () => {}}
              target='_blank'
              rel='noreferrer'
              href={directUrl}
